love.conf = (t) ->
    t.title = "Hat Shade"        -- The title of the window the game is in (string)
    t.icon = "res/logo/blanklogo.png" -- Filepath to an image to use as the window's icon (string)
    t.identity = "baf-hatshade" -- The name of the save directory (string)
    ...
    t.window.fullscreentype = "desktop" -- Standard fullscreen ("exclusive") or desktop fullscreen ("desktop") mode (string)
